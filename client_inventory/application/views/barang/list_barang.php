<div class="row">
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<a href="#" onclick="loadMenu('<?= base_url('barang/form_create') ?>')" class="btn btn-primary mb-4">Tambah Data Barang</a>
...
<script type="text/javascript">
	...
	function cariData() {
		...
		var url = 'http://localhost:8080/backend_inventory/barang/cari_barang';
		var dataForm = {};
